...
void clearchar(uint8_t *buff, uint8_t x, uint8_t line, uint8_t c);
...
uint8_t x0, uint8_t y0, uint8_t radius,
uint8_t color);
void clearfilledcircle(uint8_t *buff,uint8_t x0, uint8_t y0, uint8_t radius,uint8_t color);
